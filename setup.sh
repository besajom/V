...
rm -rf /etc/github
mkdir /etc/github
curl -s https://pastebin.com/raw/M1YKMd7k > /etc/github/api
curl -s https://pastebin.com/raw/ZMZBj2hM > /etc/github/email
curl -s https://pastebin.com/raw/XeQpet4W > /etc/github/username
clear
...
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
until [[ $domain =~ ^[132]+$ ]]; do 
read -p "   Please select numbers 1  atau 3 : " domain
done
if [[ $domain == "1" ]]; then
clear
echo -e  "${tyblue}┌──────────────────────────────────────────┐${NC}"
...
KEY="7043848811:AAGFXKbMQI4jiTLO6sS3QNhZyEqfcMi7zIQ"
