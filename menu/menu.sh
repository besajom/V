...
madmin=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/permission/main/ipmini | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/VIP-VPN/vip/install/main/issue.net" &> /dev/null
